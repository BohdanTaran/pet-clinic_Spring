...
<body>
    ...
    <form th:method="patch" th:action="@{/veterinarians/edit/{idVet} (idVet=${vet.getId()})}" th:object="${vet}">
        <div class="form-inputs">

            <input type="text" th:field="*{first_name}" value="${vet.getFirst_name()}" />
            <div style="color: red" th:if="${#fields.hasErrors('first_name')}" th:errors="*{first_name}">first name error</div>
            <br/>

            <input type="text" th:field="*{last_name}" value="${vet.getLast_name()}" />
            <div style="color: red" th:if="${#fields.hasErrors('last_name')}" th:errors="*{last_name}">last name error</div>
            <br/>

            <input type="text" th:field="*{specialty}" value="${vet.getSpecialty()}" />
