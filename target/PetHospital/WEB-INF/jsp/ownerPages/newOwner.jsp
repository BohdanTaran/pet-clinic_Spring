...
<body>
    ...
    <form id="ownerForm" th:method="post" th:action="@{/owners/new}" th:object="${owner}">
        <div class="form-inputs">
            <input type="text" th:field="*{first_last_name}" placeholder="First/Last name" />
            ...
            <br/>
            <input type="number" th:field="*{phone}" placeholder="Phone" />
            <div style="color: red" th:if="${#fields.hasErrors('phone')}" th:errors="*{phone}">phone error</div>
        </div>
        <br/><br/>
        <input id="submitForm" style="padding: 10px;
